...
{
    /// <inheritdoc />
    public partial class DeleteEmpreintTest : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Books",
                columns: new[] { "Id", "Autor", "Description", "Genre", "Price", "PublishDate", "Remarks", "Title" },
                values: new object[,]
                {
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Empreints", x => x.Id);
                });
        }
    }
}
